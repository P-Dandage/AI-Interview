...
const team = [
  {
    name: "Prathamesh Dandage",
    role: "Full Stack Developer",
    initials: "PD",
    color: "#6366f1",
    github: "https://github.com/P-Dandage/",
    linkedin: "https://www.linkedin.com/in/prathamesh-dandage-b592a3281/",
  },
  {
    name: "Aditya Shahane",
    role: "Full Stack Developer",
...
const About = () => {
  return (
    <div className="about-wrapper">
      <div className="section-label-brand">✦ THE TEAM</div>
      <h2 className="about-heading">
        Meet the Minds Behind<br/>
        <span className="about-heading-accent">IntraAi</span>
      </h2>
      <p className="about-sub">Four passionate developers building the future of AI-assisted interview preparation.</p>
